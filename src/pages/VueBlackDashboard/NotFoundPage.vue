<template>
  <div class="contact-us full-screen">
      ...
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <router-link :to="{path:'/'}" class="navbar-brand">
            <img src="/img/raima-control-wide-white.svg" class="img-fluid" style="height: 36px;" />
          </router-link>
        </div>
    ...
    <div class="wrapper wrapper-full-page section content" style="hegiht: auto; min-height: auto;">
      <div class="">
        <div class="container">
          <div class="row">
